...
int main (int argc, char *argv[])
{
    ...
    cudaMalloc((void**)&A_h, sizeof(float)*A_sz);
    cudaMalloc((void**)&B_h, sizeof(float)*B_sz);
    cudaMalloc((void**)&C_h, sizeof(float)*C_sz);
    ...
    cudaMemcpy(A_h, A_d, sizeof(float)*A_sz, cudaMemcpyHostToDevice);
    cudaMemcpy(B_h, B_d, sizeof(float)*B_sz, cudaMemcpyHostToDevice);
    cudaMemcpy(C_h, C_d, sizeof(float)*C_sz, cudaMemcpyHostToDevice);
