    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if newPosition in self.corners and newPosition not in state[1]:
                    newCorner.append(newPosition)

                successors.append(((newPosition, tuple(newCorner)), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    while unvisitedCorners:
        ...
        closestCornerDistance = util.manhattanDistance(oldPosition, closestCorner)

        for corner in unvisitedCorners[1:]:
            distance = util.manhattanDistance(oldPosition, corner)
